...
mlab.figure(bgcolor = (1,1,1))
cws.plot_surface(half=True)
cws.plot_3Dvector_field(np.moveaxis(array_renorm,2,0),half=True)
cws.plot_function_on_surface(np.linalg.norm(array,axis=2),half=True)
mlab.show()